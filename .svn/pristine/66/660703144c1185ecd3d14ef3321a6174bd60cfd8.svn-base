	...
	<div class="easyui-panel" data-options="fit:true,border:false"; title="新增|修改" style="width:100%;">
	    ...
	    <form id='formEdit'>
	    	<ul class="form_layout">
	    			...
	    			<input type="hidden" name="staffId" id="staffId" value="${sysStaff.staffId }" />
	    		
	    		<li>
	    			<span>员工编号：</span>
	    			<input type="text" name="staffCode" id="staffCode" value="${sysStaff.staffCode }" />
	    		</li>
	    		<li>
	    			<span>员工姓名：</span>
	    			<input type="text" name="staffName" id="roleName" value="${sysStaff.staffName }" />
	    		</li>
	    		<li>
	    			<span>员工性别：</span>
	    			<input type="text" name="staffGender" id="staffGender" value="${sysStaff.staffGender }" />
	    		</li>
	    		<li>
	    			<span>员工生日：</span>
	    			<input type="text" name="staffBirthday" id="staffBirthday" value="${sysStaff.staffBirthday }" />
	    		</li>
	    		<li>
	    			<span>员工电话：</span>
	    			<input type="text" name="staffMoblie" id="staffMoblie" value="${sysStaff.staffMoblie }" />
	    		</li>
	    		<li>
	    			<span>员工地址：</span>
	    			<input type="text" name="staffAddress" id="staffAddress" value="${sysStaff.staffAddress }" />
	    		</li>
	    		<li>
	    			<span>员工状态：</span>
	    			<input type="text" name="staffStatus" id="staffStatus" value="${sysStaff.staffStatus }" />
	    		</li>
	    		<li>
	    			<span>员工登录密码：</span>
	    			<input type="text" name="pwdLogin" id="pwdLogin" value="${sysStaff.pwdLogin }" />
	    		</li>
	    		<li>
	    			<span>员工信息：</span>
	    			<input type="text" name="staffInfo" id="staffInfo" value="${sysStaff.staffInfo }" />
	    		</li>
