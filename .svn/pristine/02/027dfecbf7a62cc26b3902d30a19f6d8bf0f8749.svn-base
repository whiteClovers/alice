...
<script>
	...
	function editRow(id) {
		window.location.href = 'edit.do?roleId=' + id;
	}
	...
	<div id="toolbar">
		<form id="formQuery">
			...
			<div style="padding: 6px;">
				...
				<span>角色名称:</span> 
					<input name="roleName" id="roleName"  style="border: 1px solid #ccc"> 
				<!-- <span>身份证:</span> 
					<input name="roleIdcard" id="roleIdcard"  style="border: 1px solid #ccc"> 
				<span>用户地址:</span> 
	...
	<table id='dataGridSysRole' class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<!-- <th data-options="field:'roleIdcard',width:60,align:'center'">身份证</th>
