 ...
 $(function(){
	 $('#register_btn').on('click', function () {
		 $.ajax({
				type:"post" ,
				async : true,
				url:'/Alice/front/RegisterController/insertAj.do',
				data:{
					userTel:$('#userTel').val(),
		 			pwd:$('#pwd').val(),
...
<div class="login_bg">
    ...
    <div>
        <div class="register_title" style="display:none;">
            ...
            <a class="login_btn" href="/Alice/front/LoginController/page.do">登录</a>
        </div>
        <div class="register_content">
            <div class="register_part2">
                <div class="item">
                    <input type="number" id="userTel" name="userTel" placeholder="手机号码" oninput="if(value.length>11)value=value.slice(0,11)"
                           onkeyup="value = value.replace(/[^\d{2}\.]/g, '').replace(/(\.\d{2}).*/g, '$1')"/>
                </div>
                <div class="item">
                    <input type="password" id="pwd" name="pwd" placeholder="密码6-20位字母数字组合" maxlength="20"/>
                ...
                <%-- <div class="referenceWrap">
                    <div class="referenceTitle" id="referenceTitle"><img src="<%=request.getContextPath()%>/resource/front/img/inviteperson.png">邀请人账号</div>
                ...
                <span class="register_btn disabled" style="text-align: center"
                   id="register_btn">注册</span>
<!--                 <a href="javascript:;" class="register_btn disabled" style="text-align: center"
            ...
            <div class="register_part3" style="display: none;">
                ...
                <a href="index.html" class="xqgg">先去逛逛</a>
            </div>
        </div>
    </div>
    <div class="modal" id="modal"  style="display: none;">
        <img src="<%=request.getContextPath()%>/resource/front/img/loading.svg" class="loadingImg" >
    </div>
</div>
...
<%-- <script src="<%=request.getContextPath()%>/resource/front/js/reg.js?v=1.2.2" type="text/javascript" charset="utf-8"></script> --%>
</html>