				...
				success:function(data){
					...
					$.each(data.list ,function(index,item){
				 		$.each(item,function(index2,item2){
			 				...
			 				"当前时间:" + new Date( item2.nowDate ).toLocaleString()+"</br>"+
			 				...
			 				"<a href='${pageContext.request.contextPath}/front/FrontToRepaymentsController/page.do?repayId="+item2.repayId+"' >去还款</a></br>"+ 
    ...
    <section class="container" style="background: #fff;">
        ...
        <section class="tabs">
            ...
            <ul class="tabs_sub_nav clearFix">
                ...
                <li class="list_item"><a href="${pageContext.request.contextPath}/front/FrontNeedRepaymentsController/page.do">当前需求还款的期数</a></li>
            </ul>
