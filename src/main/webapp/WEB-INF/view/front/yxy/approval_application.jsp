				...
				success:function(data){				 
					$.each(data.list ,function(index,item){
					 	 $('#information').append(
				 				...
				 				"<a href='javascript:void(0)' onclick=del('"+item.loanId+"')>取消借款</a>"+
				 				"<a style='margin-left:20px' href='${pageContext.request.contextPath}/front/FrontRepaymentsController/page.do?loanId="+item.loanId+"'>确认借款</a></br>"+
				 				"</div>"
					 	 );  				 	 	 								
					}); 
				} 		 
    ...
    <section class="container" style="background: #fff;">
        ...
        <section class="tabs">
            ...
            <<ul class="tabs_sub_nav clearFix">
                <li class="list_item "><a href="${pageContext.request.contextPath}/front/FrontApplicationController/page.do">申请中</a></li>
